...
./run_champsim.sh bimodal-no-ipcp_isca2020-ipcp_isca2020-no-no-no-no-lru-lru-lru-drrip-lru-lru-lru-lru-1core 50 50 ../../biswa/SPEC2017Traces 605.mcf_s-1644B.champsimtrace.xz stats/window_approach_test &

./run_suite.sh bimodal-no-no-no-no-no-no-no-lru-lru-lru-drrip-lru-lru-lru-lru-1core ../../biswa/SPEC2017Traces stats/window_approach_fixed_avg_miss_latency/no_pref/lru 50 50

./run_suite.sh bimodal-no-no-spp-no-no-no-no-lru-lru-lru-drrip-lru-lru-lru-lru-1core ../../biswa/SPEC2017Traces stats/window_approach_fixed_avg_miss_latency/spp/lru 50 50
...
./run_suite.sh bimodal-no-ipcp_isca2020-ipcp_isca2020-no-no-no-no-lru-lru-lru-drrip-lru-lru-lru-lru-1core ../../biswa/SPEC2017Traces stats/window_approach_fixed_avg_miss_latency/ipcp/lru 50 50
