...
./run_champsim.sh bimodal-no-no-no-no-no-no-no-lru-lru-lru-lru-lru-lru-lru-lru-1core 1 2 dpc3_traces 602.gcc_s-734B.champsimtrace.xz stats/interaction/dead_block_test