...
./run_champsim.sh bimodal-no-ipcp_isca2020_DRAMIOFREQDIV8-ipcp_isca2020-no-no-no-no-lru-lru-lru-drrip-lru-lru-lru-lru-1core 50 50 ../../biswa/SPEC2017Traces 602.gcc_s-2226B.champsimtrace.xz stats/test/micro_interaction/l1d &
...
./run_suite.sh bimodal-no-ipcp_isca2020-ipcp_isca2020-no-no-no-no-lru-lru-lrusumon123-drrip-ship++-lru-lru-lru-1core ../../biswa/SPEC2017Traces stats/window_approach_all_traces/ipcp/ship++ 50 50
...
./run_suite.sh bimodal-no-no_DRAMIOFREQDIV4-spp-no-no-no-no-lru-lru-lru-drrip-lru-lru-lru-lru-1core ../../biswa/SPEC2017Traces stats/window_approach/low_dram_bw/1600/spp/lru 50 50
./run_suite.sh bimodal-no-no_DRAMIOFREQDIV8-spp-no-no-no-no-lru-lru-lru-drrip-lru-lru-lru-lru-1core ../../biswa/SPEC2017Traces stats/window_approach/low_dram_bw/800/spp/lru 50 50