...
#single core - DIV16
awk '{print "./run_champsim.sh bimodal-no-ipcp_isca2020_DRAMIOFREQDIV16-ipcp_isca2020-no-no-no-no-lru-lru-lru-lru-lru-lru-lru-lru-1core 10 50 traces/clientserver " $1 " stats/low_bw_analysis/cs/DIV16 &"}' clientserver_trace_list.txt > clientserver_run_DIV16.sh
#single core - DIV32
awk '{print "./run_champsim.sh bimodal-no-ipcp_isca2020_DRAMIOFREQDIV32-ipcp_isca2020-no-no-no-no-lru-lru-lru-lru-lru-lru-lru-lru-1core 10 50 traces/clientserver " $1 " stats/low_bw_analysis/cs/DIV32 &"}' clientserver_trace_list.txt > clientserver_run_DIV32.sh
